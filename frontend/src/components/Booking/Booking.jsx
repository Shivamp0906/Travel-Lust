...
const Booking = ({tour, avgRating}) => {
  ...
  var totalprice = Number(booking.guestSize)*Number(price);
  const serviceFee = 10;
  ...
  return (
    <div className="booking">
      ...
      <div className="booking__bottom">
        <ListGroup>
          <ListGroupItem className="border-0 px-0" style={{background:"#2b2b2b"}} >
          ...
          <ListGroupItem className="border-0 px-0 total"  style={{background:"#2b2b2b"}} >
            <h5>Total</h5>
